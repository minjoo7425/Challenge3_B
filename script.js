...
AudioManager.load('pop',         'assets/sounds/pop (1).mp3', { volume: 0.7 });
AudioManager.load('typing',      'assets/sounds/typing.mp3',  { volume: 2 });
                ...
                <div class="mirror-scene">
                    <div class="mirror-stage">
                        ...
                        <div class="arch-mirror-wrap">
                            ...
                            <!-- 캐릭터 — 거울 앞에 60px 겹치게 -->
                            <img src="assets/character/back.png" class="mirror-character-overlay" alt="character" />
                        </div>
...
(function() {
    ...
    function _tryBGM() {
        ...
        if (s && s.paused) { s.muted = isMuted; s.currentTime = 0; s.play().catch(function(){}); }
